...
const httpProxy = require('express-http-proxy') //Package responsible for redirect request to microservices
const app = express()
...
mongoose.connect(global.mongo_connection, m_options)
  .catch(err => {
    console.log(err)
  })
...
app.use('/api/private/connectionstation/ocpps/', hasValidData);

app.post('/api/private/connectionstation/ocpps/start', (req, res, next) => {

  CS_TO_CP.remoteStartTransaction.handle(req, res, next, CentralSystemServer);
  
});

app.post('/api/private/connectionstation/ocpps/changeConfiguration', (req, res, next) => {

  CS_TO_CP.changeConfiguration.handle(req, res, next, CentralSystemServer);
  
});

app.post('/api/private/connectionstation/ocpps/reset', (req, res, next) => {

  CS_TO_CP.reset.handle(req, res, next, CentralSystemServer);
  
});

app.post('/api/private/connectionstation/ocpps/unlockConnector', (req, res, next) => {
...
app.post('/api/private/connectionstation/ocpps/stop', (req, res, next) => {
 
  CS_TO_CP.remoteStopTransaction.handle(req, res, next, CentralSystemServer);

});

app.post('/api/private/connectionstation/ocpps/getConfiguration', (req, res, next) => {
  ...
  var context = "[OCPP Server - Get Configuration]";
