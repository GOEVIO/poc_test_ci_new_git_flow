...
const notificationOldSchema = new mongoose.Schema({
    unread: {
        type: Boolean,
        required: true
    },
...
const NotificationOld = mongoose.model('NotificationOld', notificationOldSchema);
...
class MongoDB {
    ...
    _getModel(collection) {
        ...
        switch (collection.toLowerCase()) {
            case 'notificationOld':
                Collection = NotificationOld;
                break;
            case 'station':
                Collection = Station;
                break;
