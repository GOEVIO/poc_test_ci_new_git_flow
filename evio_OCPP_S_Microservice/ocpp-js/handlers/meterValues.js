...
module.exports = {
    handle: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            for (var i = 0; i < parsed.values.value.length; i++) {
                var meterRegistered = parsed.values.value[i];
                
                if (meterRegistered.attributes.measurand == global.ocppMeasTypePAI) {
                    instantPower = meterRegistered.value;
                }
                else if (meterRegistered.attributes.measurand == global.ocppMeasTypeEAIR) {
