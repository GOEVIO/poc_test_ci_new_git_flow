...
//mongoose.connect('mongodb://localhost:27017/EVIOManagementDB')
const options = {
...
async function connectionDB() {
    const connString = String(process.env.DB_URI).replace('{database}', 'EVIOManagementDB');
...
app.use('/api/private/evioIssues', require('../routes/evioIssues'));
app.use('/api/private/hostIssues', require('../routes/hostIssues'));
