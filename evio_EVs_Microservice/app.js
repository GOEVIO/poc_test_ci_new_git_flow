...
var EV = require('./models/ev');

const mongoose = require('mongoose');

//mongoose.connect('mongodb://localhost:27017/evsDB')
const options = {
...
async function connectionDB() {
    const connString = String(process.env.DB_URI).replace('{database}', 'evsDB');
...
app.use(require('./routes/evs'));
app.use(require('./routes/fleets'));
app.use(require('./routes/otherEvs'));
app.use(require('./routes/sessionsKms'));
