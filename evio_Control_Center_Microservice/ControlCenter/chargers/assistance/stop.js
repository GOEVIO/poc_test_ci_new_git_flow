...
module.exports = {
    send: (req,res) => sendRemoteStop(req,res)
};

async function sendRemoteStop(req,res) {
    let context = "Function sendRemoteStop";
    try {
        ...
        req.body.freeStopTransaction = true
        let host = process.env.HostOCPP16 + process.env.PathSendRemoteStop
