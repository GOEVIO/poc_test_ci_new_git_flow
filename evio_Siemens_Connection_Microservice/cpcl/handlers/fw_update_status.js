...
module.exports = {
    handle: function (data) {
        return new Promise(function (resolve, reject) {
            ...
            console.log(JSON.stringify("[Charging Station] FW_UPDATE_STATUS Operation"));

            try {
                var values = data["command"]["CLIENT_COMMAND"]["0"]["FW_UPDATE_STATUS"]["0"];
                ...
                console.log('[FW_UPDATE_STATUS] error: ' + error);
            }
