...
//mongoose.connect('mongodb://localhost:27017/tariffsOPCDB')
const options = {
...
async function connectionDB() {
  const connString = String(process.env.DB_URI).replace('{database}', 'externalDB');
...
app.use(require('./routes/chargersDB'));
