...
function generatePage4(doc) {
    ...
    doc
        ...
        .text('Ao preço previsto em 3.2 serão somados os custos correspondentes (i) à remuneração '
            ...
            + 'de mobilidade elétrica em vigor aprovadas pela Entidade Reguladora dos Serviços Energéticos (ERSE), (iii) outros impostos, taxas, '
            + 'tarifas, encargos ou contribuições legalmente aplicáveis ao fornecimento de eletricidade para a mobilidade elétrica '
            + 'no momento da emissão da fatura.', 125, 115,
            { align: 'justify' });
    ...
    doc
        ...
        .text('A EVIO tem a faculdade de introduzir alterações no preço a pagar pelo Cliente, mediante prévia comunicação '
            + 'nos termos previstos nas Condições Gerais, nas seguintes situações:', 125, 300,
            { align: 'justify' });
    ...
    doc
        ...
        .text('Alterações aprovadas pela ERSE nas tarifas de acesso às redes de energia elétrica para a mobilidade elétrica '
            ...
            + 'nomeadamente pela sua recomposição ou introdução de novos componentes.', 140, 360,
            { align: 'justify' });
    ...
    doc
        ...
        .text('b)', 125, 455)
        .font('assets/fonts/Nunito.ttf')
        .text('Alteração dos custos de aquisição de energia elétrica.', 140, 455,
            { align: 'justify' });
    ...
    doc
        ...
        .fontSize(13)
        .font('assets/fonts/NunitoBold.ttf')
        .text('4.   Modalidade de pagamento e faturação', 70, 550,
            { align: 'justify' });
    ...
    doc
        ...
        .text('Os pagamentos serão efetuados por débito no cartão de crédito ou da carteira. Nos pagamentos realizados através '
            + 'da carteira a taxa de ativação terá um desconto de 0,15€ em cada carregamento.', 125, 575,
            { align: 'justify' });
    ...
    doc
        ...
        .text('As faturas são emitidas com o pagamento e de forma eletrónica para o endereço de e-mail indicado pelo Cliente '
            + 'nas presentes Condições Particulares.', 125, 642,
            { align: 'justify' });
