...
*/
  ...
  16: {
    ...
    startDate: "2023-01-17T10:00:00Z",
    endDate: "2023-01-17T21:11:00Z",
    consumedPower: 6.2, // not relevant here
    plugPower: 4, //not relevant here
    total_charging_time: 671 / 60,
    total_parking_time: 0 / 60,
    expectedCost: 41.8,
    source : "MobiE"
  },
  17 : {
    ...
    startDate: "2023-01-17T23:00:00Z",
    endDate: "2023-01-18T03:00:00Z",
    consumedPower: 10, // not relevant here
    plugPower: 4, //not relevant here
    total_charging_time: 4,
...
function testOpcFinalPrices(testTariffsObj) {
  ...
  for (let key in testTariffsObj) {
    ...
    // console.log(`============================ ${key} ============================`)
    // console.log("FLAT -->" , JSON.stringify(flat.info))
    // console.log("ENERGY -->" , JSON.stringify(energy.info))
    // console.log("TIME -->" ,JSON.stringify(time.info))
    // console.log("PARKING -->" ,JSON.stringify(parking.info))
    // console.log()
    // console.log()
    // console.log()
...
function testOpcTariffsPrices(testChargingPeriodsObj, testTariffsObj) {
  ...
  for (let key in testChargingPeriodsObj) {
    ...
    let testTariff = testTariffsObj[key];
    /*
      While Gireve calculations are made with the roamingPlansDB, the source argument on
      opcTariffsPrices should be null, because the unitary values of time are in minutes. 

      Once we use the tariffs in the Tariffs Module, we must use the source Gireve or MobiE, depending on the network.
    */
...
/* 
  These functions have been changed so that then unitPrice is in euro/min and not euro/h. 
  It should be euro/h, but MobiE uses euro/min and we currently use euro/min in EVIO. 

  TODO: So the test tariffs on Gireve are wrong, either on the price and on the estimated cost. They should ne updated
*/


let mobieTestTariffs = {
  
  1: {
    tariffElements: [{
      "_id": {
          "$oid": "6151f3ff8f158e00125e23d4"
      },
      "restrictions": null,
      "price_components": [{
          "_id": {
              "$oid": "6151f3ff8f158e00125e23d5"
          },
          "type": "FLAT",
          "price": 2.5,
          "vat": 23,
      ...
      "_id": {
          "$oid": "6151f3ff8f158e00125e23d6"
      },
      "restrictions": {
          "day_of_week": null,
          "_id": {
              "$oid": "6151f3ff8f158e00125e23d7"
          },
          "reservation": null,
          "start_time": null,
          "end_time": null,
      ...
      "_id": {
          "$oid": "6151f3ff8f158e00125e23d9"
      },
      "restrictions": {
          "day_of_week": null,
          "_id": {
              "$oid": "6151f3ff8f158e00125e23da"
          },
          "reservation": null,
          "start_time": null,
          "end_time": null,
...
// testOpcFinalPrices(mobieTestTariffs);
