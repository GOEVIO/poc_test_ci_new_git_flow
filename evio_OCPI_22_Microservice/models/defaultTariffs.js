...
var DefaultTariffs = module.exports = mongoose.model('defaultTariffs', tariffsModel);
...
module.exports.updateTariff = function (query, values, callback) {
    DefaultTariffs.findOneAndUpdate(query, values, callback);
    
};

module.exports.removeTariff = function (query, callback) {
    DefaultTariffs.findOneAndRemove(query, callback);
};
