...
const platformsModel = new Schema({
    ...
    platformDetails: [versionsDetails],
    ...
    evioActiveCredentialsToken: [token], //Token to access EVIO OCPI Platform
    evioTokensHistory: [tokensHistory],
    evioURL: { type: String },
    platformActiveCredentialsToken: [token], //Token to access to 3º party OCPI Platform
    platformTokensHistory: [tokensHistory],
    credendialExchanged: { type: Boolean },
    generateNewTokenEndpointUpdate: { type: Boolean },
    generateNewTokenDeleteCredentials: { type: Boolean },
    active: { type: Boolean },
    source: { type: String },
    locationsScheduleTimeCronJob: { type: String },
    locationsBulkLastUpdateDate: { type: Boolean },
    tariffsScheduleTimeCronJob: { type: String },
    tariffsBulkLastUpdateDate: { type: Boolean },
    cdrsScheduleTimeCronJob: { type: String },
    sftpCdrsScheduleTimeCronJob: { type: String },
    cdrsBulkLastUpdateDate: { type: Boolean },
    sessionsScheduleTimeCronJob: { type: String },
