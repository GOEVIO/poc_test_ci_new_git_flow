...
class SendRejectResponse extends Error {
	 ...
	 * @param {Enums.SessionFlowLogsStatus} params.status - The status of the session flow.
	...
	constructor({
		...
		action = '',
		stage = '',
		errorType = Enums.SessionFlowLogsErrorTypes.UNKNOWN_ERROR,
		logMessage = '',
		stage_pre_fix = '',
