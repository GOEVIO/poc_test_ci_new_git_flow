...
export enum PUBLIC_GRID_MEASUREMENTS {
...
export enum PLUG_CONTROL_TYPES {
    AUTO = 'AUTO',
    MANUAL = 'MANUAL',
    OFF = 'OFF',
    BOOST = 'BOOST',
