const SCSibsCards = require('../models/scSibsCards');
            ...
            try {
                ...
                Promise.all(listCards.map((card, index) => {
                    return new Promise(async resolve => {
                        ...
                        let newCard = new SCSibsCards(card);
                        let cardFound = await SCSibsCards.findOne({ cardNumber: newCard.cardNumber });

                        if (cardFound) {

                            let cardUpdated = await SCSibsCards.findOneAndUpdate({ _id: cardFound._id }, { $set: card }, { new: true });
                            resolve(cardUpdated)

                        } else {

                            SCSibsCards.createSCSibsCards(newCard, (err, result) => {
                                if (err) {
    ...
    getSibsCards: () => {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let cardsFound = await SCSibsCards.find({});
                resolve(cardsFound);
    ...
    getSibsCardsByCardNumber: (req) => {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let cardFound = await SCSibsCards.findOne({ cardNumber: cardNumber, inUse: false });
    ...
    updateInUse: (req) => {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let cardUpdated = await SCSibsCards.findOneAndUpdate({ cardNumber: cardNumber }, { $set: { inUse: true } }, { new: true });
                resolve(cardUpdated);
    ...
    updateCard: (cardNumber) => {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let cardFound = await SCSibsCards.findOneAndUpdate({ cardNumber: cardNumber }, { $set: { inUse: true } }, { new: true });
                resolve(cardFound);
    ...
    updateNotInUse: (cardNumber) => {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let cardFound = await SCSibsCards.findOneAndUpdate({ cardNumber: cardNumber }, { $set: { inUse: false } }, { new: true });
                resolve(cardFound);
