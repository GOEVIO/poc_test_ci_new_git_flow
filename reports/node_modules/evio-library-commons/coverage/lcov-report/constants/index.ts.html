...
<head>
    <title>Code coverage report for constants/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">constants</a> index.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export const DBNames = {
  Configs: 'configsDB',
  Chargers: 'chargersDB',
...
&nbsp;
export const Environment = (process.env.NODE_ENV || <span class="branch-1 cbranch-no" title="branch not covered" >'development')</span> as EnvironmentType
&nbsp;
export const Energy = {
  supplierName: 'ENGNE',
  contracts: {
...
&nbsp;
export { <span class="fstat-no" title="function not covered" >default </span>as checkDigitLists } from './digitLists.json'
&nbsp;
